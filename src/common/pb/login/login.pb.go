...
type LoginQueueInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	QueueSize    int32 `protobuf:"varint,1,opt,name=QueueSize,proto3" json:"QueueSize,omitempty"`
	SelfPotision int32 `protobuf:"varint,2,opt,name=SelfPotision,proto3" json:"SelfPotision,omitempty"`
}

func (x *LoginQueueInfo) Reset() {
	*x = LoginQueueInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoginQueueInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginQueueInfo) ProtoMessage() {}

func (x *LoginQueueInfo) ProtoReflect() protoreflect.Message {
	mi := &file_proto_login_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginQueueInfo.ProtoReflect.Descriptor instead.
func (*LoginQueueInfo) Descriptor() ([]byte, []int) {
	return file_proto_login_proto_rawDescGZIP(), []int{2}
}

func (x *LoginQueueInfo) GetQueueSize() int32 {
	if x != nil {
		return x.QueueSize
	}
	return 0
...
func (x *LoginQueueInfo) GetSelfPotision() int32 {
	if x != nil {
		return x.SelfPotision
	}
	return 0
}
...
var file_proto_login_proto_rawDesc = []byte{
	...
	,
...
var file_proto_login_proto_goTypes = []interface{}{
	...
	(*LoginQueueInfo)(nil), // 2: login.LoginQueueInfo
}
